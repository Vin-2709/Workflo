...
const AdminModal = ({ task, onClose, onUploadSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 bg-[rgba(0,0,0,0.2)] backdrop-blur-md flex items-center justify-center z-50 transition-opacity duration-300 opacity-300">
      <div className="bg-indigo-900 rounded-lg w-[600px] min-h-[670px]  p-10 relative flex flex-col text-white shadow-lg shadow-black">
        ...
        <div className="mb-6">
          <h3 className="font-medium mb-2">Employee Uploaded Files</h3>
