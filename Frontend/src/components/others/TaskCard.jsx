...
const TaskCard= ({data,onstatusUpdate,openModal})=>{
    ...
    const handleUpload = async () => {
     ...
     return (
        <div className='flex flex-col bg-gray-200 text-black m-2 p-4 min-h-[500px] rounded-lg min-w-[400px] shadow-lg shadow-blue-700 mt-8 hover:scale-105 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 ease-out cursor-pointer'>
