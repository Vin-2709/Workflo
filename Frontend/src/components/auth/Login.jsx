...
const Login = ({ loggedinuser }) => {
  ...
  return (
    <div className=" bg-radial-[at_50%_75%] from-blue-300 via-blue-400 to-indigo-500 to-90% min-h-screen flex flex-col justify-start  items-center h-screen  min-w-screen overflow-x-hidden">
